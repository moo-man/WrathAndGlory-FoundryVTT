...
choice = await game.wng.utility.disciplinePowerDialog(["Divination", "Runes of Fate", "Runes of Fortune"], {number: 2, text: "Choose 2 Powers from Divination, Runes of Fate, or Runes of Fortune", title: this.item.name})

items = items.concat(choice.map(i => i.uuid));
