...
let choice = await game.wng.utility.disciplinePowerDialog("Runes of Battle", {text: "Choose one Psychic Power from the Runes of Battle Discipline", title: this.item.name})
