...
choice = await game.wng.utility.disciplinePowerDialog(["Divination", "Phantasmancy", "Telepathy"], {number: 2, text: "Choose 2 Powers from Divination, Phantasmancy, or Telepathy", title: this.item.name})
